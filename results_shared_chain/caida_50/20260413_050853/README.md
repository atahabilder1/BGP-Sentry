...
**Dataset:** `caida_50` | **Date:** 2026-04-13T05:13:56 | **Duration:** 302.7s | **Speed:** 1.0x
...
| Consensus Commit Rate | 39.0% | LOW -- increase timeout or reduce threshold |
...
| Valid Chains | 26/26 |
| Blocks/Node (min/avg/max) | 6/43.3/61 |
| Transactions/Node (min/avg/max) | 5/46.1/66 |
| Total Forks Detected | 23628 |
...
| Committed (consensus reached) | 1,031 |
| Pending (timed out / not enough votes) | 0 |
| **Commit Rate** | **39.0%** |

> **Low commit rate (39.0%).** Consider: increase `P2P_REGULAR_TIMEOUT` (currently 20s), increase `P2P_MAX_BROADCAST_PEERS` (currently 9), or lower `CONSENSUS_CAP_SIGNATURES` (currently 2).
...
| Treasury Balance | 9,982,492 |
| Total Distributed | 17,508 |
| Circulating Supply | 17,508 |
| Participating Nodes | 26 |
| Distribution Rate | 0.18% of supply |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 34,085 |
| Messages Delivered | 34,085 |
| Messages Dropped | 0 |
...
- **Low commit rate (39.0%)**: Increase `P2P_REGULAR_TIMEOUT` (currently 20s) to give voters more time, or increase `P2P_MAX_BROADCAST_PEERS` (currently 9) to query more voters.

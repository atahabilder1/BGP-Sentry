...
Usage:
  python3 scripts/score_detection.py results/5008_lacnic_5plus_mh/hop1_20260422_122914/
  python3 scripts/score_detection.py path/to/detection_results.json
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 scripts/score_detection.py <results_dir_or_detection_results.json>")
        sys.exit(1)

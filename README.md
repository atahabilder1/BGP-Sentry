...
# 2. Run experiment with a BFS dataset
python3 main_experiment.py --dataset bfsTopology/caida_bfs_174_50

# 3. Run with longer duration
python3 main_experiment.py --dataset bfsTopology/caida_bfs_174_150 --duration 600

# 4. Run with larger dataset
python3 main_experiment.py --dataset bfsTopology/caida_bfs_174_800 --duration 600
```
...
# Single dataset
python3 main_experiment.py --dataset bfsTopology/caida_bfs_174_50
python3 main_experiment.py --dataset bfsTopology/caida_bfs_174_150 --duration 300
python3 main_experiment.py --dataset bfsTopology/caida_bfs_174_400 --duration 600
python3 main_experiment.py --dataset bfsTopology/caida_bfs_174_800 --duration 600

# Run all BFS datasets sequentially
for ds in caida_bfs_174_50 caida_bfs_174_150 caida_bfs_174_400 caida_bfs_174_800 caida_bfs_174_1200; do
    python3 main_experiment.py --dataset bfsTopology/$ds --duration 600
done
```
...
python3 scripts/generate_vrp.py dataset/bfsTopology/caida_bfs_174_50 stayrtr/vrp_generated.json
...
Located in `dataset/bfsTopology/`. Each dataset is a **BFS-expanded subgraph** from a Tier-1 seed AS (AS174 Cogent) on the real CAIDA AS-level Internet topology. BFS produces naturally connected subgraphs — no artificial bridge reconnection needed. RPKI classification is real-world data from rov-collector (6 sources).

| Dataset | ASes | Seed | Method |
|---------|------|------|--------|
| `caida_bfs_174_50` | 50 | AS174 | BFS expansion |
| `caida_bfs_174_150` | 150 | AS174 | BFS expansion |
| `caida_bfs_174_400` | 400 | AS174 | BFS expansion |
| `caida_bfs_174_800` | 800 | AS174 | BFS expansion |
| `caida_bfs_174_1200` | 1200 | AS174 | BFS expansion |
...
*Results pending — experiments will be run on the new BFS-expanded datasets (5 sizes: 50 to 1200 ASes). Results will be populated here after simulation runs complete.*
...
BGP-Sentry/
  ...
  dataset/                            # CAIDA datasets (version controlled)
    ...
    bfsTopology/                      # BFS-expanded subgraphs from AS174
      caida_bfs_174_50/
      caida_bfs_174_150/
      caida_bfs_174_400/
      caida_bfs_174_800/
...
```bash
# Interactive mode
python3 analysis/blockchain_explorer.py results/caida_bfs_174_50/*/blockchain.json

# Verify chain integrity
python3 analysis/blockchain_explorer.py results/caida_bfs_174_50/*/blockchain.json --verify

# List all attack verdicts
python3 analysis/blockchain_explorer.py results/caida_bfs_174_50/*/blockchain.json --verdicts

# Search by prefix or AS
python3 analysis/blockchain_explorer.py results/caida_bfs_174_50/*/blockchain.json --search-prefix "8.8.8.0/24"
python3 analysis/blockchain_explorer.py results/caida_bfs_174_50/*/blockchain.json --search-as 15169
```

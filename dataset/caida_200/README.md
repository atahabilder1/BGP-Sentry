# BGPSentry Dataset - CAIDA Subgraph (200 Nodes)
...
- **All 200 nodes** exported (no sampling) for blockchain consensus integrity
...
- **Method**: BFS from highest-degree AS to extract 200-node connected subgraph
...
|--------|-------|
| **Total ASes** | 200 |
| **RPKI ASes (validators)** | 101 (50.5%) |
| **Non-RPKI ASes (observers)** | 99 (49.5%) |
| **Total Announcements** | 15,038 |
| **Total Attacks** | 476 (3.17%) |
| **Legitimate** | 14,562 |
...
├── observations/                  # 200 individual AS files (ALL nodes, real ASNs)
│   ├── AS<real_asn>.json
│   └── ...
└── ground_truth/
    ├── ground_truth.csv
...
@misc{bgpsentry_dataset_caida,
  title = {BGPSentry BGP Dataset (CAIDA Subgraph, 200 Nodes)},

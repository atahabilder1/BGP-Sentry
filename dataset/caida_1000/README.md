# BGPSentry Dataset - CAIDA Subgraph (1000 Nodes)
...
- **All 1000 nodes** exported (no sampling) for blockchain consensus integrity
...
- **Method**: BFS from highest-degree AS to extract 1000-node connected subgraph
...
|--------|-------|
| **Total ASes** | 1,000 |
| **RPKI ASes (validators)** | 366 (36.6%) |
| **Non-RPKI ASes (observers)** | 634 (63.4%) |
| **Total Announcements** | 80,665 |
| **Total Attacks** | 3,704 (4.59%) |
| **Legitimate** | 76,961 |
...
|-------------|-------|
| PREFIX_HIJACK | 1,234 |
| SUBPREFIX_HIJACK | 1,234 |
| BOGON_INJECTION | 1,234 |
| ROUTE_FLAPPING | 2 |
...
├── observations/                  # 1000 individual AS files (ALL nodes, real ASNs)
│   ├── AS<real_asn>.json
│   └── ...
└── ground_truth/
    ├── ground_truth.csv
...
@misc{bgpsentry_dataset_caida,
  title = {BGPSentry BGP Dataset (CAIDA Subgraph, 1000 Nodes)},

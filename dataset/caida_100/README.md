# BGPSentry Dataset - CAIDA Subgraph (100 Nodes)
...
- **All 100 nodes** exported (no sampling) for blockchain consensus integrity
...
- **Method**: BFS from highest-degree AS to extract 100-node connected subgraph
...
|--------|-------|
| **Total ASes** | 100 |
| **RPKI ASes (validators)** | 58 (58.0%) |
| **Non-RPKI ASes (observers)** | 42 (42.0%) |
| **Total Announcements** | 7,069 |
| **Total Attacks** | 333 (4.71%) |
| **Legitimate** | 6,736 |
...
├── observations/                  # 100 individual AS files (ALL nodes, real ASNs)
│   ├── AS<real_asn>.json
│   └── ...
└── ground_truth/
    ├── ground_truth.csv
...
@misc{bgpsentry_dataset_caida,
  title = {BGPSentry BGP Dataset (CAIDA Subgraph, 100 Nodes)},

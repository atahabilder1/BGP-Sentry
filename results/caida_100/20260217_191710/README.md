...
**Dataset:** `caida_100` | **Date:** 2026-02-17T19:20:06 | **Duration:** 175.3s
...
| Committed (consensus reached) | 2,853 |
| Pending (timed out / not enough votes) | 67 |
| **Commit Rate** | **99.6%** |
...
| Treasury Balance | 9,974,277 |
| Total Distributed | 25,723 |
| Circulating Supply | 25,623 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 303,779 |
| Messages Delivered | 274,078 |
| Messages Dropped | 0 |

...
**Dataset:** `caida_100` | **Date:** 2026-02-17T18:53:26 | **Duration:** 435.6s
...
| Committed (consensus reached) | 2,211 |
| Pending (timed out / not enough votes) | 18 |
| **Commit Rate** | **77.2%** |
...
| Treasury Balance | 9,960,669 |
| Total Distributed | 39,331 |
| Circulating Supply | 39,091 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 313,241 |
| Messages Delivered | 313,228 |
| Messages Dropped | 0 |

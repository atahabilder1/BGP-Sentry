...
**Dataset:** `caida_100` | **Date:** 2026-02-17T19:10:00 | **Duration:** 250.4s
...
| Treasury Balance | 9,974,188 |
| Total Distributed | 25,812 |
| Circulating Supply | 25,752 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 301,194 |
| Messages Delivered | 263,843 |
| Messages Dropped | 0 |

...
**Dataset:** `caida_100` | **Date:** 2026-02-18T04:41:58 | **Duration:** 303.1s | **Speed:** 1.0x
...
| Network TPS (all nodes combined) | 22.2 | GOOD |
| Consensus Commit Rate | 92.8% | GOOD |
| Blockchain Integrity | Valid | PASS |
| Message Delivery | 94.2% | PASS |
...
| Wall-Clock Time | 303.1s |
| Total Observations Processed | 6,736 |
| **Network TPS (all nodes combined)** | **22.2** |
| Per-Node TPS (network TPS / node count) | 0.222 |
...
| Committed (consensus reached) | 2,475 |
| Pending (timed out / not enough votes) | 254 |
| **Commit Rate** | **92.8%** |
...
| Treasury Balance | 9,969,363 |
| Total Distributed | 30,637 |
| Circulating Supply | 30,617 |
| Participating Nodes | 58 |
| Distribution Rate | 0.31% of supply |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 167,458 |
| Messages Delivered | 157,812 |
| Messages Dropped | 0 |
| Delivery Rate | 94.24% |

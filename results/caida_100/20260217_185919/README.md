...
**Dataset:** `caida_100` | **Date:** 2026-02-17T19:04:10 | **Duration:** 290.4s
...
| Committed (consensus reached) | 2,812 |
| Pending (timed out / not enough votes) | 93 |
| **Commit Rate** | **98.2%** |
...
| Treasury Balance | 9,972,622 |
| Total Distributed | 27,378 |
| Circulating Supply | 27,378 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 263,936 |
| Messages Delivered | 261,901 |
| Messages Dropped | 0 |

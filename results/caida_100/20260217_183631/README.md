...
**Dataset:** `caida_100` | **Date:** 2026-02-17T18:46:07 | **Duration:** 575.7s
...
| Committed (consensus reached) | 2,302 |
| Pending (timed out / not enough votes) | 56 |
| **Commit Rate** | **80.4%** |
...
| Treasury Balance | 9,952,664 |
| Total Distributed | 47,336 |
| Circulating Supply | 45,836 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 380,444 |
| Messages Delivered | 380,068 |
| Messages Dropped | 0 |

...
**Dataset:** `caida_100` | **Date:** 2026-02-18T05:18:22 | **Duration:** 301.6s | **Speed:** 4.0x
...
| Parameter | Value | Description |
|-----------|-------|-------------|
| `SIMULATION_SPEED_MULTIPLIER` | 4.0x | 1.0 = real-time |
...
| Treasury Balance | 9,991,348 |
| Total Distributed | 8,652 |
| Circulating Supply | 8,652 |
...
- **100 nodes incomplete**: Increase `--duration` or reduce `SIMULATION_SPEED_MULTIPLIER` (currently 4.0x).

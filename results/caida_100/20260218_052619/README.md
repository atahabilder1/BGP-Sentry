...
**Dataset:** `caida_100` | **Date:** 2026-02-18T05:31:12 | **Duration:** 292.3s | **Speed:** 6.0x
...
| Parameter | Value | Description |
|-----------|-------|-------------|
| `SIMULATION_SPEED_MULTIPLIER` | 6.0x | 1.0 = real-time |
...
| Metric | Value |
|--------|-------|
| Speed Multiplier | 6.0x |
| Wall-Clock Time | 292.3s |
| Total Observations Processed | 7,069 |
| **Network TPS (all nodes combined)** | **24.2** |
| Per-Node TPS (network TPS / node count) | 0.242 |
...
|--------|-------|
| Total Blocks | 2,862 |
| Total Transactions | 2,861 |
| Latest Block # | 2861 |
| Integrity Valid | No |
| Integrity Errors | Block 2755: Hash mismatch; Block 2755: Merkle root mismatch; Block 2761: Hash mismatch |
| Node Replicas | 58 |
...
| Pending (timed out / not enough votes) | 58 |
| **Commit Rate** | **100.0%** |
...
| Treasury Balance | 9,990,900 |
| Total Distributed | 9,100 |
| Circulating Supply | 9,100 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 270,206 |
| Messages Delivered | 270,162 |
| Messages Dropped | 0 |
| Delivery Rate | 99.98% |

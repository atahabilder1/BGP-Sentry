...
**Dataset:** `caida_100` | **Date:** 2026-02-17T22:34:07 | **Duration:** 303.9s | **Speed:** 1.0x
...
| Precision | 0.0000 | LOW -- false positives: 2 |
| Recall | 0.0000 | MISSED 4 attacks |
| Network TPS | 22.2 | GOOD |
| Consensus Commit Rate | 89.5% | GOOD |
| Blockchain Integrity | Valid | PASS |
| Message Delivery | 89.3% | PASS |
...
> **2 false positives detected.** Most are from route flapping. To reduce: increase `FLAP_THRESHOLD` (currently 5) or increase `FLAP_WINDOW_SECONDS`.
...
| Committed (consensus reached) | 2,388 |
| Pending (timed out / not enough votes) | 309 |
| **Commit Rate** | **89.5%** |
...
| Treasury Balance | 9,969,613 |
| Total Distributed | 30,387 |
| Circulating Supply | 28,887 |
| Participating Nodes | 58 |
| Distribution Rate | 0.30% of supply |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 156,865 |
| Messages Delivered | 140,018 |
| Messages Dropped | 0 |
| Delivery Rate | 89.26% |

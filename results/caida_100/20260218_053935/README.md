...
**Dataset:** `caida_100` | **Date:** 2026-02-18T05:42:51 | **Duration:** 196.3s | **Speed:** 9.0x
...
| Recall | 1.0000 | PASS |
| Network TPS (all nodes combined) | 36.0 | GOOD |
| Consensus Commit Rate | 99.5% | GOOD |
| Blockchain Integrity | Valid | PASS |
| Message Delivery | 32.2% | PASS |
...
| Parameter | Value | Description |
|-----------|-------|-------------|
| `SIMULATION_SPEED_MULTIPLIER` | 9.0x | 1.0 = real-time |
...
| Metric | Value |
|--------|-------|
| Speed Multiplier | 9.0x |
| Wall-Clock Time | 196.3s |
| Total Observations Processed | 7,069 |
| **Network TPS (all nodes combined)** | **36.0** |
...
| Committed (consensus reached) | 2,850 |
| Pending (timed out / not enough votes) | 72 |
| **Commit Rate** | **99.5%** |
...
| Treasury Balance | 9,993,117 |
| Total Distributed | 6,883 |
| Circulating Supply | 6,883 |
| Participating Nodes | 58 |
| Distribution Rate | 0.07% of supply |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 183,985 |
| Messages Delivered | 59,243 |
| Messages Dropped | 0 |
| Delivery Rate | 32.20% |
...
- **Try increasing speed**: Set `SIMULATION_SPEED_MULTIPLIER=10.0` to test higher throughput.

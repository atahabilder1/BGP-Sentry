...
**Dataset:** `caida_100` | **Date:** 2026-02-18T13:28:14 | **Duration:** 300.5s | **Speed:** 1.0x
...
| Network TPS (all nodes combined) | 22.4 | GOOD |
...
| Wall-Clock Time | 300.5s |
| Total Observations Processed | 6,736 |
| **Network TPS (all nodes combined)** | **22.4** |
| Per-Node TPS (network TPS / node count) | 0.224 |
...
| Treasury Balance | 9,954,439 |
| Total Distributed | 45,561 |
| Circulating Supply | 45,561 |
| Participating Nodes | 58 |
| Distribution Rate | 0.46% of supply |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 178,756 |
| Messages Delivered | 178,756 |
| Messages Dropped | 0 |

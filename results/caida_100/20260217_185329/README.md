...
**Dataset:** `caida_100` | **Date:** 2026-02-17T18:59:15 | **Duration:** 345.5s
...
| Committed (consensus reached) | 2,113 |
...
| Treasury Balance | 9,969,827 |
| Total Distributed | 30,173 |
| Circulating Supply | 30,113 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 327,585 |
| Messages Delivered | 268,362 |
| Messages Dropped | 0 |

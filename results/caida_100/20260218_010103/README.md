...
**Dataset:** `caida_100` | **Date:** 2026-02-18T01:03:04 | **Duration:** 120.8s | **Speed:** 1.0x
...
| Network TPS (all nodes combined) | 23.6 | GOOD |
...
| Wall-Clock Time | 120.8s |
| Total Observations Processed | 2,849 |
| **Network TPS (all nodes combined)** | **23.6** |
| Per-Node TPS (network TPS / node count) | 0.236 |
...
| Pending (timed out / not enough votes) | 19 |
| **Commit Rate** | **100.0%** |
...
| Treasury Balance | 9,979,546 |
| Total Distributed | 20,454 |
| Circulating Supply | 20,454 |
| Participating Nodes | 58 |
| Distribution Rate | 0.20% of supply |
...
| Total Skipped | 849 (12.0% of observations) |

...
**Dataset:** `caida_100` | **Date:** 2026-02-18T04:55:27 | **Duration:** 304.5s | **Speed:** 2.0x
...
| Network TPS (all nodes combined) | 22.1 | GOOD |
...
| Parameter | Value | Description |
|-----------|-------|-------------|
| `SIMULATION_SPEED_MULTIPLIER` | 2.0x | 1.0 = real-time |
...
| Wall-Clock Time | 304.5s |
| Total Observations Processed | 6,736 |
| **Network TPS (all nodes combined)** | **22.1** |
| Per-Node TPS (network TPS / node count) | 0.221 |
...
|--------|-------|
| Total Blocks | 2,670 |
| Total Transactions | 2,669 |
| Latest Block # | 2669 |
| Integrity Valid | No |
| Integrity Errors | Block 2612: Hash mismatch; Block 2612: Merkle root mismatch |
| Node Replicas | 58 |
...
| Treasury Balance | 9,970,799 |
| Total Distributed | 29,201 |
| Circulating Supply | 29,181 |
| Participating Nodes | 58 |
| Distribution Rate | 0.29% of supply |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 182,119 |
| Messages Delivered | 182,119 |
| Messages Dropped | 0 |
...
- **100 nodes incomplete**: Increase `--duration` or reduce `SIMULATION_SPEED_MULTIPLIER` (currently 2.0x).

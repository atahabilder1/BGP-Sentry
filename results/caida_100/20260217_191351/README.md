...
**Dataset:** `caida_100` | **Date:** 2026-02-17T19:17:06 | **Duration:** 195.3s
...
| Treasury Balance | 9,976,495 |
| Total Distributed | 23,505 |
| Circulating Supply | 23,505 |
...
| Metric | Value |
|--------|-------|
| Messages Sent | 274,917 |
| Messages Delivered | 233,798 |
| Messages Dropped | 0 |

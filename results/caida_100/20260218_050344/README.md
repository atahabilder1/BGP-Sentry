...
**Dataset:** `caida_100` | **Date:** 2026-02-18T05:08:46 | **Duration:** 301.6s | **Speed:** 3.0x
...
| Parameter | Value | Description |
|-----------|-------|-------------|
| `SIMULATION_SPEED_MULTIPLIER` | 3.0x | 1.0 = real-time |
...
| Treasury Balance | 9,987,333 |
| Total Distributed | 12,667 |
| Circulating Supply | 12,667 |
...
- **100 nodes incomplete**: Increase `--duration` or reduce `SIMULATION_SPEED_MULTIPLIER` (currently 3.0x).
